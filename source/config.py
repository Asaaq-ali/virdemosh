...
API_ID = int(getenv("21627756"))
API_HASH = getenv("fe77fbf0cae9f7f5ece37659e2466cf1")
...
LOGGER_ID = int(getenv("LOGGER_ID","-1001936852140"))
MUSIC_BOT_NAME = int(getenv("MUSIC_BOT_NAME","dina")) 
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Asaaq-ali/vcbnm",
)
